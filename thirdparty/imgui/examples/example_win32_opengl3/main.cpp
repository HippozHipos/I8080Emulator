// Dear ImGui: standalone example Simulation for Win32 + OpenGL 3
...
int main(int, char**)
{
    ...
    // - If the file cannot be loaded, the function will return NULL. Please handle those errors in your Simulation (e.g. use an assertion, or display an error and quit).
